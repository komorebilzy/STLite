...
//                printf("&left=%llx &t=%llx t=%llx\n", &t1->parent->left, &t, t);
        ...
        pair<iterator, bool> insert1(const value_type &value, node *&t) {
            if (t == nullptr) {
                t = new node(value, 1, nullptr, nullptr, flag);
                iterator m(t, this);
                return pair<iterator, bool>(m, true);

            } else if (Compare()(value.first, t->data.first)) {
                flag = t;
                pair<iterator, bool> tmp(insert1(value, t->left));
                ...
                flag = t;
                pair<iterator, bool> tmp(insert1(value, t->right));
                ...
                iterator m(t, this);
                return pair<iterator, bool>(m, false);
            }
        ...
        pair<iterator, bool> insert(const value_type &value) {
            flag = nullptr;
            pair<iterator, bool> tmp(insert1(value, root));
            if (tmp.second) num++;
            return tmp;
        }
